...
public:
	...
	void TankDrive() {
		if(pad1.GetRawAxis(1)<0.0||pad1.GetRawAxis(5)<0.0) {
				l_f.Set(-pad1.GetRawAxis(1) * 0.8);
				r_f.Set(pad1.GetRawAxis(5) * 0.8);
				l_b.Set(-pad1.GetRawAxis(1) * 0.8);
				r_b.Set(pad1.GetRawAxis(5) * 0.8);
				UpdateJag_pV_Val();
			}
		else {
				l_b.Set(-pad1.GetRawAxis(1) * 0.8);
