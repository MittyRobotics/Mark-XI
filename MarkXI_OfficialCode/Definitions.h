...
const float ARM_MAXIMUM_POSITION = -0.20;
...
/*const int PISTON_RETRACT_SOLENOID_A = 2;
const int PISTON_RETRACT_SOLENOID_B = 5;
const int LATCH_RETRACT_SOLENOID_A = 3;
const int LATCH_RETRACT_SOLENOID_B = 6;*/

const int PISTON_RETRACT_SOLENOID_A = 2;
const int PISTON_RETRACT_SOLENOID_B = 5;
const int LATCH_RETRACT_SOLENOID_A = 6;
const int LATCH_RETRACT_SOLENOID_B = 3;

const int DRIVE_SHIFTER_SOLENOID_A = 7;
const int DRIVE_SHIFTER_SOLENOID_B = 4;

const int PISTON_SWITCH_RETRACT_CHANNEL = 6;
const int PISTON_SWITCH_EXTEND_CHANNEL = 9;
const int LATCH_PISTON_LOCK_SWITCH_CHANNEL = 8;
const int IS_COCKED_SWITCH_CHANNEL = 14;
const int BALL_LIMIT_SWITCH = 1;
const int ARM_OPTICAL_SWITCH = 2;
